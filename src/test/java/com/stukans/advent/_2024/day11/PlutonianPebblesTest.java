...
class PlutonianPebblesTest {
    ...
    private static final String folder = "/2024/day11";

    private static Stream<Arguments> inputs1() {
        return Stream.of(
                Arguments.of(folder + "/test.txt", 55312)
                , Arguments.of(folder + "/input.txt", 217812)
    ...
    void puzzle1(String path, long output) throws IOException {
        ...
        Puzzle puzzle = new PlutonianPebbles();
    ...
    private static Stream<Arguments> inputs2() {
        return Stream.of(
                Arguments.of(folder + "/input.txt", 259112729857522L)
