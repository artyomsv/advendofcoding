...
class LensLibraryTest {
    ...
    private static Stream<Arguments> games() {
        return Stream.of(
                Arguments.of("/2023/puzzle15/short1.txt", 1320)
                , Arguments.of("/2023/puzzle15/data.txt", 512797)
    ...
    private static Stream<Arguments> games2() {
        return Stream.of(
                Arguments.of("/2023/puzzle15/short1.txt", 145)
                , Arguments.of("/2023/puzzle15/data.txt", 262454)
